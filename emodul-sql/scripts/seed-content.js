// ============================================
// seed-content.js — Script Seed Konten Pembelajaran Online
// E-Modul Interaktif SQL - SMK Negeri 1 Sintuk Toboh Gadang
// ============================================
// Jalankan: node scripts/seed-content.js
// ============================================
...
const VIDEO_DATA = [
  {
    id: "video_keg1_1",
    judul: "Pengenalan SQL, XAMPP & MySQL Shell",
    urlYoutube: "https://www.youtube-nocookie.com/embed/HXV3zeQKqGY",
    materiId: "materi_keg1_1",
    kegiatanKe: 1,
    urutan: 1
  },
  {
    id: "video_keg1_2",
    judul: "Praktik DDL: Membuat Database & Tabel",
    urlYoutube: "https://www.youtube-nocookie.com/embed/znexfO0u2aM",
    materiId: "materi_keg1_2",
    kegiatanKe: 1,
    urutan: 2
  },
  {
    id: "video_keg1_3",
    judul: "Praktik DDL: ALTER, RENAME & DROP Table",
    urlYoutube: "https://www.youtube-nocookie.com/embed/Cz3WcZlrPRg",
    materiId: "materi_keg1_3",
    kegiatanKe: 1,
    urutan: 3
  },
  {
    id: "video_keg2_1",
    judul: "Praktik DML: INSERT & SELECT Dasar",
    urlYoutube: "https://www.youtube-nocookie.com/embed/7S_tz1z_5bA",
    materiId: "materi_keg2_1",
    kegiatanKe: 2,
    urutan: 1
  },
  {
    id: "video_keg2_2",
    judul: "Praktik DML: Pencarian Pola WHERE & LIKE",
    urlYoutube: "https://www.youtube-nocookie.com/embed/9Pzj7Aj25lw",
    materiId: "materi_keg2_2",
    kegiatanKe: 2,
    urutan: 2
  },
  {
    id: "video_keg2_3",
    judul: "Praktik DML: UPDATE & DELETE Data",
    urlYoutube: "https://www.youtube-nocookie.com/embed/7Vtl2HPZeGg",
    materiId: "materi_keg2_3",
    kegiatanKe: 2,
    urutan: 3
  },
  {
    id: "video_keg3_1",
    judul: "Keamanan Database: CREATE USER & ALTER USER",
    urlYoutube: "https://www.youtube-nocookie.com/embed/1Oz49pDqX8s",
    materiId: "materi_keg3_1",
    kegiatanKe: 3,
    urutan: 1
  },
  {
    id: "video_keg3_2",
    judul: "Otorisasi Database: GRANT, REVOKE & FLUSH PRIVILEGES",
    urlYoutube: "https://www.youtube-nocookie.com/embed/4yP85W3pM5c",
    materiId: "materi_keg3_2",
    kegiatanKe: 3,
    urutan: 2
  }
];
...
const LATIHAN_DATA = [
  // --- Latihan Kegiatan 1 ---
  {
    ...
    soal: [
      {
        pertanyaan: "Huruf 'M' pada singkatan perangkat lunak XAMPP merujuk pada…",
        opsi: ["Microsoft", "Mozilla", "MySQL / MariaDB", "MongoDB"],
        jawabanBenarIndex: 2
      },
      {
        pertanyaan: "Perintah shell/terminal yang digunakan untuk mengaktifkan koneksi ke server MySQL sebagai root adalah…",
        opsi: ["start mysql", "mysql -u root -p", "connect mysql root", "run mysql server"],
        jawabanBenarIndex: 1
      },
      {
        pertanyaan: "Bahasa SQL pertama kali dikembangkan oleh para peneliti IBM berdasarkan teori relational dari…",
        opsi: ["Bill Gates", "Dr. E.F. Codd", "James Gosling", "Dennis Ritchie"],
        jawabanBenarIndex: 1
      }
    ]
  },
  {
    ...
    soal: [
      {
        pertanyaan: "Perintah DDL yang digunakan untuk mengaktifkan atau membuka database yang akan digunakan adalah…",
        opsi: ["OPEN database;", "USE database;", "SELECT database;", "ACTIVE database;"],
        jawabanBenarIndex: 1
      },
      {
        pertanyaan: "Perintah SQL untuk melihat deskripsi dan struktur kolom tabel secara rinci adalah…",
        opsi: ["SHOW TABLE", "DESC / DESCRIBE", "VIEW TABLE", "LIST COLUMNS"],
        jawabanBenarIndex: 1
      },
      {
        pertanyaan: "Atribut kolom yang menyatakan bahwa kolom tersebut wajib diisi dan tidak boleh bernilai kosong adalah…",
        opsi: ["PRIMARY KEY", "NOT NULL", "UNIQUE", "DEFAULT"],
        jawabanBenarIndex: 1
      }
    ]
  },
  {
    ...
    soal: [
      {
        pertanyaan: "Perintah DDL untuk menambahkan kolom baru bernama 'kelas' bertipe INT ke tabel 'murid' adalah…",
        opsi: [
          "ALTER TABLE murid ADD kelas INT;",
          "INSERT INTO murid COLUMN kelas INT;",
          "MODIFY TABLE murid ADD kelas INT;",
          "UPDATE TABLE murid NEW kelas INT;"
        ],
        jawabanBenarIndex: 0
      },
      {
        pertanyaan: "Perintah untuk mengubah nama tabel 'siswa' menjadi 'murid' adalah…",
        opsi: [
          "CHANGE TABLE siswa TO murid;",
          "RENAME TABLE siswa TO murid;",
          "UPDATE TABLE siswa NAME murid;",
          "ALTER TABLE siswa NAME murid;"
        ],
        jawabanBenarIndex: 1
      }
    ]
  ...
  // --- Latihan Kegiatan 2 ---
  {
    ...
    soal: [
      {
        pertanyaan: "Perintah DML yang digunakan untuk menambahkan baris data (record) baru ke dalam tabel adalah…",
        opsi: ["ADD ROW", "INSERT INTO", "CREATE DATA", "PUT INTO"],
        jawabanBenarIndex: 1
      },
      {
        pertanyaan: "Perbedaan utama antara kelompok perintah DDL dan DML adalah…",
        opsi: [
          "DDL mengolah isi record data, sedangkan DML membuat struktur tabel",
          "DDL membangun dan mengubah struktur database/tabel, sedangkan DML mengolah isi record data",
          "DDL mengatur hak akses user, sedangkan DML membuat database",
          "Tidak ada perbedaan antara DDL dan DML"
        ],
        jawabanBenarIndex: 1
      }
    ]
  },
  {
    ...
    soal: [
      {
        pertanyaan: "Query untuk menampilkan data murid yang beralamat di daerah yang mengandung kata 'Solo' adalah…",
        opsi: [
          "SELECT * FROM murid WHERE alamat = '%Solo%';",
          "SELECT * FROM murid WHERE alamat LIKE '%Solo%';",
          "SELECT * FROM murid WHERE alamat IS 'Solo';",
          "SELECT * FROM murid SEARCH alamat = 'Solo';"
        ],
        jawabanBenarIndex: 1
      },
      {
        pertanyaan: "Pola wildcard LIKE '%A' pada query pencarian SQL memiliki arti…",
        opsi: [
          "Mencari data yang diawali huruf A",
          "Mencari data yang berakhiran huruf A",
          "Mencari data yang mengandung huruf A di posisi mana saja",
          "Mencari data yang tepat terdiri dari 1 huruf A"
        ],
        jawabanBenarIndex: 1
      }
    ]
  },
  {
    ...
    soal: [
      {
        pertanyaan: "Apa dampak yang terjadi jika perintah UPDATE dijalankan tanpa menyertakan klausa WHERE?",
        opsi: [
          "Sistem SQL akan menampilkan error syntax",
          "Hanya baris pertama saja yang diperbarui",
          "Seluruh baris record dalam tabel akan terubah nilainya",
          "Tidak ada perubahan sama sekali pada data"
        ],
        jawabanBenarIndex: 2
      },
      {
        pertanyaan: "Perintah untuk menghapus data murid yang memiliki NISN '10003' adalah…",
        opsi: [
          "DROP FROM murid WHERE nisn = '10003';",
          "DELETE FROM murid WHERE nisn = '10003';",
          "REMOVE FROM murid WHERE nisn = '10003';",
          "TRUNCATE murid WHERE nisn = '10003';"
        ],
        jawabanBenarIndex: 1
      }
    ]
  ...
  // --- Latihan Kegiatan 3 ---
  {
    ...
    soal: [
      {
        pertanyaan: "Perintah DCL yang digunakan untuk membuat akun user baru pada database MySQL adalah…",
        opsi: [
          "ADD USER 'nama_user'@'localhost';",
          "NEW USER 'nama_user'@'localhost';",
          "CREATE USER 'nama_user'@'localhost' IDENTIFIED BY 'password';",
          "MAKE USER 'nama_user'@'localhost' WITH PASSWORD 'password';"
        ],
        jawabanBenarIndex: 2
      },
      {
        pertanyaan: "Istilah 'localhost' pada pembuatan user database merepresentasikan…",
        opsi: [
          "Host komputer lokal/server itu sendiri",
          "Jaringan internet publik",
          "Domain website sekolah",
          "Nama database utama"
        ],
        jawabanBenarIndex: 0
      }
  ...
  },
  {
    ...
    soal: [
      {
        pertanyaan: "Perintah DCL yang digunakan untuk memberikan izin akses manipulasi tabel ke pengguna database adalah…",
        opsi: ["ALLOW", "PERMIT", "GRANT", "AUTHORIZE"],
        jawabanBenarIndex: 2
      },
      {
        pertanyaan: "Perintah untuk mencabut kembali izin hak akses yang sebelumnya telah diberikan kepada user adalah…",
        opsi: ["REVOKE", "REMOVE GRANT", "DELETE PRIVILEGES", "CANCEL"],
        jawabanBenarIndex: 0
      },
      {
        pertanyaan: "Untuk melihat daftar hak akses yang dimiliki oleh user 'guru_sql'@'localhost', perintah yang digunakan adalah…",
        opsi: [
          "VIEW GRANTS 'guru_sql'@'localhost';",
          "SHOW GRANTS FOR 'guru_sql'@'localhost';",
          "SELECT GRANTS FROM 'guru_sql'@'localhost';",
          "DESCRIBE USER 'guru_sql'@'localhost';"
        ],
        jawabanBenarIndex: 1
      }
    ]
...
// ============================================
// DATA KUIS EVALUASI AKHIR
// ============================================
const KUIS_DATA = {
  id: "kuis-akhir",
  judul: "Evaluasi Akhir — Penguasaan SQL (DDL, DML, DCL)",
  soal: [
    {
      pertanyaan: "1. Bahasa database yang dikembangkan oleh IBM berdasarkan teori Relational Dr. E.F. Codd pada awalnya bernama…",
      opsi: ["SEQUEL", "MYSQL", "POSTGRES", "SQLITE"],
      jawabanBenarIndex: 0
    },
    {
      pertanyaan: "2. Pada paket software XAMPP, huruf 'A' dan 'M' masing-masing merupakan singkatan dari…",
      opsi: [
        "Admin dan Memory",
        "Apache dan MySQL",
        "Application dan Maria",
        "Access dan Management"
      ],
      jawabanBenarIndex: 1
    },
    {
      pertanyaan: "3. Perintah SQL yang termasuk ke dalam kategori DDL (Data Definition Language) adalah…",
      opsi: ["SELECT dan INSERT", "CREATE dan ALTER", "GRANT dan REVOKE", "UPDATE dan DELETE"],
      jawabanBenarIndex: 1
    },
    {
      pertanyaan: "4. Perintah yang tepat untuk membuat database baru bernama 'sekolah' hanya jika database tersebut belum ada adalah…",
      opsi: [
        "CREATE DATABASE NEW sekolah;",
        "CREATE DATABASE IF NOT EXISTS sekolah;",
        "MAKE DATABASE sekolah IF EMPTY;",
        "CHECK AND CREATE DATABASE sekolah;"
      ],
      jawabanBenarIndex: 1
    },
    {
      pertanyaan: "5. Perintah DDL untuk mengubah tipe data kolom 'nisn' pada tabel 'murid' menjadi INT(8) adalah…",
      opsi: [
        "ALTER TABLE murid MODIFY nisn INT(8);",
        "UPDATE TABLE murid CHANGE nisn INT(8);",
        "ALTER TABLE murid SET nisn INT(8);",
        "MODIFY COLUMN nisn INT(8) ON murid;"
      ],
      jawabanBenarIndex: 0
    },
    {
      pertanyaan: "6. Perintah DML yang digunakan untuk menyisipkan data baru ke dalam tabel adalah…",
      opsi: ["INSERT INTO", "ADD ROW", "PUSH INTO", "UPDATE DATA"],
      jawabanBenarIndex: 0
    },
    {
      pertanyaan: "7. Query yang digunakan untuk menampilkan data siswa yang beralamat di kota yang berakhiran huruf 'A' adalah…",
      opsi: [
        "SELECT * FROM murid WHERE alamat LIKE 'A%';",
        "SELECT * FROM murid WHERE alamat LIKE '%A';",
        "SELECT * FROM murid WHERE alamat LIKE '%A%';",
        "SELECT * FROM murid WHERE alamat = 'A';"
      ],
      jawabanBenarIndex: 1
    },
    {
      pertanyaan: "8. Mengapa penambahan klausa WHERE sangat penting saat menjalankan perintah UPDATE atau DELETE?",
      opsi: [
        "Agar query berjalan lebih cepat",
        "Karena jika tidak menggunakan WHERE, operasi akan mempengaruhi seluruh baris dalam tabel",
        "Agar database tidak terkunci (locked)",
        "Klausa WHERE wajib dituliskan menurut sintaks ANSI"
      ],
      jawabanBenarIndex: 1
    },
    {
      pertanyaan: "9. Perintah DCL yang digunakan untuk memberikan izin akses membaca (SELECT) dan menambah (INSERT) kepada user adalah…",
      opsi: ["PERMIT", "ALLOW", "GRANT", "REVOKE"],
      jawabanBenarIndex: 2
    },
    {
      pertanyaan: "10. Perintah DCL yang digunakan untuk mencabut izin akses yang sudah diberikan kepada pengguna database adalah…",
      opsi: ["REVOKE", "REMOVE", "DELETE PERMISSION", "UNGRANT"],
      jawabanBenarIndex: 0
    }
  ]
};
...
async function main() {
  console.log("==============================================");
  console.log("  SEED KONTEN — E-Modul Interaktif SQL");
  console.log("  SMK Negeri 1 Sintuk Toboh Gadang");
  console.log("  Proyek: emodul-sql-client");
  console.log("==============================================\n");

  try {
    // 1. Seed Materi
    console.log("📘 Menabur data koleksi 'materi'...");
    for (const materi of MATERI_DATA) {
      const docRef = dbAdmin.collection("materi").doc(materi.id);
      await docRef.set({
        judul: materi.judul,
        kontenHtml: materi.kontenHtml,
        urutan: materi.urutan,
        kegiatanKe: materi.kegiatanKe,
        updatedAt: admin.firestore.FieldValue.serverTimestamp()
      }, { merge: true });
      console.log(`   ✔ [Kegiatan ${materi.kegiatanKe}] Materi: ${materi.judul}`);
    }

    // 2. Seed Video
    console.log("\n🎬 Menabur data koleksi 'video'...");
    for (const vid of VIDEO_DATA) {
      const docRef = dbAdmin.collection("video").doc(vid.id);
      await docRef.set({
        judul: vid.judul,
        urlYoutube: vid.urlYoutube,
        materiId: vid.materiId,
        kegiatanKe: vid.kegiatanKe,
        urutan: vid.urutan,
        updatedAt: admin.firestore.FieldValue.serverTimestamp()
      }, { merge: true });
      console.log(`   ✔ [Kegiatan ${vid.kegiatanKe} - #${vid.urutan}] Video: ${vid.judul}`);
    }

    // 3. Seed Soal Latihan
    console.log("\n✏️ Menabur data koleksi 'latihan'...");
    for (const lat of LATIHAN_DATA) {
      const docRef = dbAdmin.collection("latihan").doc(lat.id);
      await docRef.set({
        materiId: lat.materiId,
        soal: lat.soal,
        updatedAt: admin.firestore.FieldValue.serverTimestamp()
      }, { merge: true });
      console.log(`   ✔ Latihan untuk ID Materi: ${lat.materiId} (${lat.soal.length} soal)`);
    }

    // 4. Seed Kuis Evaluasi Akhir
    console.log("\n📝 Menabur data koleksi 'kuis'...");
    const kuisRef = dbAdmin.collection("kuis").doc(KUIS_DATA.id);
    await kuisRef.set({
      judul: KUIS_DATA.judul,
      soal: KUIS_DATA.soal,
      status: "published",
      updatedAt: admin.firestore.FieldValue.serverTimestamp()
    }, { merge: true });
    console.log(`   ✔ Kuis Evaluasi Akhir (${KUIS_DATA.soal.length} soal) [Status: published]`);

    console.log("\n==============================================");
    console.log("  🎉 SEED KONTEN PEMBELAJARAN BERHASIL!");
    console.log("==============================================");
    process.exit(0);

  } catch (error) {
    console.error("\n❌ Gagal melakukan seed konten:", error);
    process.exit(1);
  }
}
